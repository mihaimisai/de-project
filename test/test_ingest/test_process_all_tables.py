...
from src.ingest.function.utils.process_all_tables import process_all_tables


@patch("src.ingest.function.utils.process_all_tables.ingest_data_to_s3")
@patch("src.ingest.function.utils.process_all_tables.s3_client")
@patch("src.ingest.function.utils.process_all_tables.logger")
