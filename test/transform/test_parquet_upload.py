...
def test_success_upload(dummy_df, dummy_logger, s3_client):
    ...
    # Call the function (this should perform parquet conversion, upload, and file removal)
    ...
    info_calls = [call_arg[0][0] for call_arg in dummy_logger.info.call_args_list]
