...
class TestConnectToDb:
    ...
    def test_connects_to_db_success(self, mock_access, mock_connection, test_logger): # noqa
        connect_to_db(test_logger)
    ...
    def test_connects_to_db_logs_info(self, mock_access, mock_connection, test_logger): # noqa
